...
💡 Key Insights
Supply Chain Gap: 12.14% of the catalog is currently out of stock, indicating potential revenue leakage in high-demand categories.

Logistics Load: Cooking Essentials and Munchies account for over 42.42% of the warehouse weight, suggesting Zepto should prioritize heavy-vehicle routing for these zones.

Revenue Concentration: Top 10 High-Value SKUs represent a significant portion of capital exposure, requiring strict inventory turnover monitoring.
